...
public class SwitchControllerUP: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // เลื่อนขึ้น
        doorRaisedPosition = new Vector3(door.transform.position.x, door.transform.position.y + moveDistance, door.transform.position.z);
    }
